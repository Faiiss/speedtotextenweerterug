...
startRecognition = () => {
  if (SpeechRecognition !== undefined) { // test if speechrecognitio is supported
    ...
    recognition.lang = 'pt-BR'; // which language is used?
...
actionSpeech = (speechText) => {
  ...
  switch(speechText){ 
    ...
    case "help me":
      ...
      break;
    case "vini":
      window.open("https://www.linkedin.com/in/vinicius-sousa-b9ab2321b/");
      break;
    case "shopping":
      window.open("https://www.amazon.com");
      break;
    case "Ã³culos":
      window.open("https://assets.catawiki.nl/assets/2018/3/14/a/1/e/a1e089d5-39da-47f9-85fd-586cd454ec86.jpg");
      break;
